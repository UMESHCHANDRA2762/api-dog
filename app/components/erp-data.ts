...
export const erpData: ErpData = {
  Organization: {
    ...
    tree: [
      ...
      { label: "Define Business Area", icon: "bi-chevron-right" },
      { label: "Assign Business Area to Company", icon: "bi-chevron-right" },
      { label: "Define Functional Area", icon: "bi-chevron-right" },
      { label: "Assign Functional Area to Company", icon: "bi-chevron-right" },
      { label: "Define Credit Control", icon: "bi-chevron-right" },
      { label: "Assign Company to Credit Control", icon: "bi-chevron-right" },
      { label: "Define Segments", icon: "bi-chevron-right" },
      { label: "Define Financial Management Area", icon: "bi-chevron-right" },
      { label: "Assign Company to Financial Mgt Area", icon: "bi-chevron-right" },
    ],
  },
  Finance: {
    title: "Finance",
